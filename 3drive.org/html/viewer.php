...
<html>
  ...
  <body>
    ...
    <div id="sidebar">
      ...
      <div id = "buttonsDiv">
        <button id="tbutton" class="visButton imgButton"></button>
        <button id="lbutton" class="visButton imgButton"></button>
        <button id="mbutton" class="visButton imgButton"></button>
        <button id ="sbutton" class="imgButton"></button><br>
      </div>
    </div>
    <div id = "previewFig"
      <figure>
